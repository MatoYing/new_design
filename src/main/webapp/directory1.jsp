<nav class="topnav navbar navbar-expand shadow justify-content-between justify-content-sm-start navbar-light bg-white" id="sidenavAccordion">
    ...
    <form class="form-inline me-auto d-none d-lg-block me-3">
        <div class="input-group input-group-joined input-group-solid mt-3">
    ...
    <ul class="navbar-nav align-items-center ms-auto">
        <li class="nav-item dropdown no-caret me-3 d-lg-none">
            <a class="btn btn-icon btn-transparent-dark dropdown-toggle" id="searchDropdown" href="#" role="button" data-bs-toggle="dropdown"><i data-feather="search"></i></a>
            <!-- Dropdown - Search-->
        ...
        <li class="nav-item dropdown no-caret d-none d-sm-block me-3 dropdown-notifications">
            <a class="btn btn-icon btn-transparent-dark dropdown-toggle" id="navbarDropdownAlerts" href="javascript:void(0);" role="button" data-bs-toggle="dropdown"><i data-feather="bell"></i></a>
            <div class="dropdown-menu dropdown-menu-end border-0 shadow animated--fade-in-up">
                ...
                <a class="dropdown-item dropdown-notifications-item" href="#!" data-bs-toggle="modal" data-bs-target="#exampleModal1">
                    ...
                    <div class="dropdown-notifications-item-content">
                        <div class="dropdown-notifications-item-content-details">2021-9-15</div>
                        <div class="dropdown-notifications-item-content-text">通知</div>
                    </div>
                </a>
                <!-- Example Alert 2-->
                <a class="dropdown-item dropdown-notifications-item" href="#!" data-bs-toggle="modal" data-bs-target="#exampleModal1">
                    ...
                    <div class="dropdown-notifications-item-content">
                        <div class="dropdown-notifications-item-content-details">2021-9-15&nbsp;&nbsp;&nbsp;<span class="badge bg-warning-soft text-warning ms-auto">New!</span></div>
                        <div class="dropdown-notifications-item-content-text">通知</div>
                    </div>
                </a>
                <!-- Example Alert 3-->
...
<%--                                    </div>--%>
        ...
        <li class="nav-item dropdown no-caret dropdown-user me-3 me-lg-4">
            <a class="btn btn-icon btn-transparent-dark dropdown-toggle" id="navbarDropdownUserImage" href="javascript:void(0);" role="button" data-bs-toggle="dropdown"><img class="img-fluid" src="/photo/profile-1.png"/></a>
            <div class="dropdown-menu dropdown-menu-end border-0 shadow animated--fade-in-up">
                <h6 class="dropdown-header d-flex align-items-center">
                    <img class="dropdown-user-img" src="/photo/profile-1.png" />
