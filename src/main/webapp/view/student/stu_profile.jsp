                ...
                <main>
                    ...
                    <div class="container-xl px-4 mt-4">
                        ...
                        <nav class="nav nav-borders">
                            <a class="nav-link active ms-0" href="stu_profile.jsp">个人</a>
                            <a class="nav-link" href="stu_score.jsp">成绩</a>
                        </nav>
                        <hr class="mt-0 mb-4" />
                        <div class="row">
                            <div class="col-xl-4">
                                        ...
                                        <form>
                                            ...
                                            <div class="row gx-3 mb-3">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input class="form-control" id="inputPhone" type="tel" placeholder="信息与电子工程学院" value="555-123-4567" readonly="readonly"/>
                                                </div>
                                                <!-- Form Group (birthday)-->
                                                <div class="col-md-6 mb-3">
                                                    <label class="small mb-1" for="inputBirthday">班级</label>
                                                    <input class="form-control" id="inputBirthday" type="text" name="birthday" placeholder="软件工程193" value="06/10/1988" readonly="readonly"/>
                                                </div>
                                            </div>
                                            <!-- Save changes button-->
