        ...
        <main>
                ...
                <div class="container-xl px-4">
                    <div class="page-header-content">
                        <div class="row align-items-center justify-content-between pt-3">
                            ...
                            <div class="col-12 col-xl-auto mb-3">School of Economics and Management</div>
                        </div>
                    </div>
                </div>
            </header>
            ...
            <div class="container-xl px-4 mt-5">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <c:forEach items='<%=subjects.select_subject_sql("经济管理学院")%>' var="subject" begin="0" end="2"><%-- 取3个 --%>
